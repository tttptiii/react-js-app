...
function Objects(props) {
  return (
    <div className="App">
      ...
      <img src={img17} className="image-style-1" alt="17" />
      <img src={img18} className="image-style-1" alt="18" />
      <img src={img19} className="image-style-1" alt="19" />
      <img src={img20} className="image-style-1" alt="20" />
      <img src={img21} className="image-style-1" alt="21" />
      <img src={img22} className="image-style-1" alt="22" />
      <img src={img23} className="image-style-1" alt="23" />
    </div>
  );
}
